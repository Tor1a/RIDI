            ...
            <div class="header_Inner">
                <div class="header_Top">
                    <div class="logo_Search">
                        <h1 class="logo"><a href="/RIDI">RIDI <span class="tone_Down">RIDI</span></a></h1>
                        <form action="" method="POST">
                            <input type="text" name="search_Box" id="search_Box" placeholder="제목, 저자, 출판사검색">
                ...
                <nav>
                    <ul class="headerMenu">
                        ...
                        <c:if test="${!empty sessionScope.loggedMember }">
	                        <li><a href="MemberInfoModifyForm.do"><i class="far fa-user"></i>마이리디</a></li>
                    	</c:if>
